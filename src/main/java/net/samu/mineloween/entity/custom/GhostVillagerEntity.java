...
public class GhostVillagerEntity extends AnimalEntity {
    public final AnimationState idleAnimationState = new AnimationState();
    private int idleAnimationTimeout = 0;

    public GhostVillagerEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public static DefaultAttributeContainer.Builder createGhostVillagerAttributes() {
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return ModEntities.GHOST_VILLAGER.create(world);
    }
