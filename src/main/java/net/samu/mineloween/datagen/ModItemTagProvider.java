...
public class ModItemTagProvider extends FabricTagProvider.ItemTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup arg) {
        ...
        getOrCreateTagBuilder(ItemTags.LEAVES).add(ModBlocks.ASH_LEAVES.asItem());
        getOrCreateTagBuilder(ItemTags.LEAVES).add(ModBlocks.AUTUMNAL_ASH_LEAVES.asItem());
        getOrCreateTagBuilder(ItemTags.PLANKS).add(ModBlocks.ASH_PLANKS.asItem());
        getOrCreateTagBuilder(ItemTags.WOODEN_STAIRS).add(ModBlocks.ASH_WOOD_STAIRS.asItem());
        getOrCreateTagBuilder(ItemTags.WOODEN_SLABS).add(ModBlocks.ASH_WOOD_SLAB.asItem());
